...
function webserverTask() {
  return src("./dev/").pipe(webserver({ livereload: true, open: true }));
}
...
exports.default = series(
  parallel(scripts, copyHtml, sassTask, assetsTask),
...
function bundleApp(isProduction) {
  ...
  return appBundler
    ...
    .pipe(
      preprocess({
        context: { NODE_ENV: isProduction ? "production" : "development" },
      })
    )
